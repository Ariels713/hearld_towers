...
import game from "../public/assets/jackies/game.jpg"
        ...
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="max-w-4xl mt-5 mx-auto text-xl text-gray-500">
              Designed with blatant enthusiasm, The Game Room at Herald Towers
              is exquisite. A vintage sports haven, the room features cards
              tables, chess boards, a pool table, video games, Pac-man,
              shuffleboard and darts, all encompassed in the striking
              surroundings of an old school inspired locker room.
            </p>
          </div>
        </div>
      </div>
